  ...
  static ThemeData get light => ThemeData(
        ...
        navigationBarTheme: NavigationBarThemeData(
          ...
          labelTextStyle: WidgetStateProperty.all(
            const TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: AppColors.secondaryText),
          ),
        ),
        ...
        chipTheme: ChipThemeData(
          ...
          labelStyle: const TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: AppColors.secondaryText),
        ),
      );
}
