...
export default function AdminShell({ children }: { children: React.ReactNode }) {
  ...
  function logout() { localStorage.removeItem('jobsinc_token'); localStorage.removeItem('jobsinc_admin_user'); document.cookie = 'jobsinc_token=; path=/; max-age=0'; document.cookie = 'jobsinc_admin_user=; path=/; max-age=0'; window.location.assign('/admin/login'); }
