...
export default function DashboardFaqError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <section className="dashboard-content">
      <div className="dashboard-state dashboard-error" style={{ minHeight: '40vh' }}>
        ...
        <strong style={{ color: '#10233f', fontSize: 16 }}>Impossible de charger la FAQ</strong>
